		   ...
		   <?php $sql = (new \yii\db\Query()) -> select('*') -> from('makale') -> All();
			...
			{?>
				<tr>
					...
					<td>
						<?php echo $deneme['Konu'];  ?>
					</td>
					<td style="display:none">
						<?php echo $deneme['Metin'];  ?>
					</td>
					<td>
					...
					<?php }endforeach; ?>
						<button style="background:white;border:none" value="<?php echo $deneme['Metin']."</br><b><hr /></b></br><b><span style='color:blue' class='glyphicon glyphicon-comment'></span>   YORUMLAR</b>".$yorum;  ?>" type="button" class="dialogGo" data-toggle="modal" data-target="#myModal">
						<a value="<?php echo $deneme['Metin'];  ?>" class="dialogGo" href="#"><span class="glyphicon glyphicon-book"></span></a>
						</button>
					</td>
				</tr>
